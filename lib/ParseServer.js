...
var ParseServer = function () {
  function ParseServer(_ref) {
    var _ref$appId = _ref.appId,
        ...
        _ref$masterKeyIps = _ref.masterKeyIps,
        masterKeyIps = _ref$masterKeyIps === undefined ? [] : _ref$masterKeyIps,
    ...
    masterKeyIps = Array.from(new Set(masterKeyIps.concat(_defaults2.default.masterKeyIps, masterKeyIps)));
    ...
    var loggerController = new _LoggerController.LoggerController(loggerControllerAdapter, appId, loggerOptions);
